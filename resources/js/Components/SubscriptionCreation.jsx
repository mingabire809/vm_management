...
export default function SubscriptionCreation({open, setOpen, subscriptionName, subscriptionId, amount}){

    const { data, setData, post, processing, errors, recentlySuccessful } =
    useForm({
        phone: "",
        rateplan_id: subscriptionId,
        amount: amount
                                    ...
                                    <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                        ...
                                        <div className="mt-2">
                                            <p className="text-sm text-gray-500">
                                                Total amount is Ksh {amount.toLocaleString()}
                                            </p>
                                        </div>
